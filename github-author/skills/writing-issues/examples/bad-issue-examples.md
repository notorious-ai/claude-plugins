...
`SKILL.md` states the rules. A case earns its place here by showing a distinct failure mode, not by re-arguing why the rule exists.
...
Each case below reads like diligence, and that is what makes it hard to catch.
