...
**Correct approach:** Discover existing tags first (see `list-vault-tags.sh` in the skill directory) and prefer them. Only create new tags when no existing tag fits.
